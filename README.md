...
5. **Basic NWS coverage validation** - non-US coordinates now return HTTP 400 using US/territory bounding boxes; production systems may use polygon-level geospatial checks for better edge precision.
